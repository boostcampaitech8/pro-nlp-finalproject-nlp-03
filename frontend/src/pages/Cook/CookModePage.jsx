    ...
    <div className="recipe-container">
      ...
      <div className="main-card">
        ...
        <div className="recipe-display-section">
          <div className="step-indicator">Step {recipeSteps[currentStepIndex].id}</div>
          <p className="step-description">{recipeSteps[currentStepIndex].text}</p>
        </div>

        <div className="image-nav-container">
          <button className="nav-btn" onClick={handlePrev} disabled={currentStepIndex === 0}>
          ...
          <button className="nav-btn" onClick={handleNext} disabled={currentStepIndex === recipeSteps.length - 1}>
            <span className="arrow-icon">〉</span>
          </button>
        </div>
        ...
        <div className="bottom-sheet-trigger" onClick={() => setIsBottomSheetOpen(true)}>
